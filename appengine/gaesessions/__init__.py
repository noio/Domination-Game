...
COOKIE_KEY = "Not using signed cookies so I guess I'm good here, with the key being public and all."
...
class DjangoSessionMiddleware(object):
    ...
    def __init__(self):
        ...
        self.wrapped_wsgi_middleware = SessionMiddleware(fake_app, cookie_key=COOKIE_KEY, cookie_only_threshold=0, no_datastore=True)
